...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-12 xl:px-12 2xl:px-20 w-full mx-auto h-full overflow-y-scroll'>
      <h1 className='text-xl font-semibold mb-6 text-gray-800 dark:text-purple-100'>Community Images</h1>
      {
        images.length > 0 ? (
          <div className='flex flex-wrap max-sm:justify-center gap-5'>
            {     /* target _blank is used so that image will open in new tab */
        ...
        :
        (
          <p className='text-center text-gray-600 dark:text-purple-200 mt-10'>No images published yet.</p>
        )
      }
    </div>
  )
